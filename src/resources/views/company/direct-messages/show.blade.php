    ...
    <div class="bg-white border border-gray-200 rounded-xl shadow-sm overflow-hidden">
        ...
        <div class="px-5 py-4 border-b border-gray-200 flex items-center justify-between gap-4 bg-gradient-to-b from-white to-gray-50">
            <div class="flex items-center gap-3 min-w-0">
                <a href="{{ route('direct-messages.index') }}" class="w-10 h-10 rounded-full border border-gray-200 bg-white flex items-center justify-center text-gray-600 hover:bg-gray-50 flex-shrink-0">
        ...
        <div class="border-t border-gray-200 p-4 bg-white">
            <form method="POST" action="{{ route('direct-messages.reply', ['direct_conversation' => $conversation->id]) }}" class="space-y-3">
                @csrf
                <textarea
                    id="dmContent"
                    name="content"
                ...
                <div class="flex justify-end">
                    <button id="dmSendButton" type="submit" class="px-6 py-2 bg-orange-500 text-white font-bold rounded-lg hover:bg-orange-600 disabled:bg-gray-300 disabled:cursor-not-allowed" disabled>
                        送信
                    </button>
                </div>
            </form>
