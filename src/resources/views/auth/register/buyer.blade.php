...
<head>
    ...
    <title>購入者登録（ログイン情報登録） - AITECH</title>
...
<body>
    ...
    <div class="container px-4 md:px-6 lg:px-8 py-10">
        <div class="register-card p-6 md:p-10 lg:p-12">
            <div class="page-title text-lg md:text-xl font-black text-center">購入者登録（ログイン情報登録）</div>
            ...
            <form class="register-form" method="POST" action="{{ route('auth.register.buyer.store') }}">
                @csrf
